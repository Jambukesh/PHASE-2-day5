...
insert into bank.Customer(CId,CName,CEmail,Contact) values ('6','Rayar','rayar@yahoo.com','98765321')
insert into bank.Customer(CId,CName,CEmail,Contact) values ('8','jambukesh','jambu@yahoo.com','8974312')
insert into bank.Customer(CId,CName,CEmail,Contact) values ('9','Deepack','deepack@yahoo.com','9745831')